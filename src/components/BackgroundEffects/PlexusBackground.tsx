...
export default function PlexusBackground() {
  ...
  useEffect(() => {
    ...
    const particleCount = 150; // Increased density
    const connectionDistance = 180; // Increased radius
    ...
    class Particle {
      ...
      constructor() {
        ...
        this.vy = (Math.random() - 0.5) * 1.2; // Faster
        this.size = Math.random() * 2.5 + 1;
        this.color = Math.random() > 0.5 ? 'rgba(0, 255, 136, 0.4)' : 'rgba(0, 243, 255, 0.4)';
      }
